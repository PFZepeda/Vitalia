...
<?php endif; ?>
            ...
            <section class="flex flex-col items-center gap-4 sm:gap-5">
                <div class="relative">
                    <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($this->profilePhotoUrl): ?>
                        <img src="<?php echo e($this->profilePhotoUrl); ?>" alt="Foto de perfil de <?php echo e($ownerName); ?>"
                ...
                <div class="text-center">
                    <p class="text-[18px] font-semibold text-slate-950 sm:text-[20px]"><?php echo e($ownerName); ?></p>
                    <p class="mt-1 text-[14px] text-slate-500 sm:text-[15px]"><?php echo e($email); ?></p>
...
unset($__errorArgs, $__bag); ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if ENDBLOCK]><![endif]--><?php endif; ?>
                    ...
                    <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($statusMessage): ?>
                        <p class="mt-3 text-sm text-emerald-600"><?php echo e($statusMessage); ?></p>
                    <?php endif; ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if ENDBLOCK]><![endif]--><?php endif; ?>
            ...
            <section class="grid grid-cols-1 gap-4 sm:gap-5">
                <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($isCaregiver || $isPatient || $isDoctor || $isPharmacist || $isAdmin): ?>
                    <a href="<?php echo e(route('profile.information')); ?>"
                ...
                <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($isCaregiver): ?>
                    <a href="<?php echo e(route('profile.view-patients')); ?>"
                        class="flex h-full items-center gap-4 rounded-3xl bg-white px-4 py-4 shadow-[0_6px_20px_rgba(15,23,42,0.05)] transition-transform hover:scale-[1.01] sm:px-5">
                        <div
                            class="flex h-16 w-20 shrink-0 items-center justify-center rounded-2xl bg-[#e2e5e9] text-[#0b67c2] sm:h-20 sm:w-24">
                            <svg viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg"
                    ...
                    <a href="<?php echo e(route('profile.be-patient')); ?>"
                        class="flex h-full items-center gap-4 rounded-3xl bg-white px-4 py-4 shadow-[0_6px_20px_rgba(15,23,42,0.05)] transition-transform hover:scale-[1.01] sm:px-5">
                        <div
                            class="flex h-16 w-20 shrink-0 items-center justify-center rounded-2xl bg-[#e2e5e9] text-[#0b67c2] sm:h-20 sm:w-24">
                ...
                <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($isPatient): ?>
                    <a href="<?php echo e(route('profile.be-caregiver')); ?>"
                        class="flex h-full items-center gap-4 rounded-3xl bg-white px-4 py-4 shadow-[0_6px_20px_rgba(15,23,42,0.05)] transition-transform hover:scale-[1.01] sm:px-5">
                        <div
                            class="flex h-16 w-20 shrink-0 items-center justify-center rounded-2xl bg-[#e2e5e9] text-[#0b67c2] sm:h-20 sm:w-24">
                            <svg viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg"
                ...
                <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($isDoctor): ?>
                    <a href="<?php echo e(route('profile.professional-data')); ?>"
                        class="flex h-full items-center gap-4 rounded-3xl bg-white px-4 py-4 shadow-[0_6px_20px_rgba(15,23,42,0.05)] transition-transform hover:scale-[1.01] sm:px-5">
                        <div
                            class="flex h-16 w-20 shrink-0 items-center justify-center rounded-2xl bg-[#e2e5e9] text-[#0b67c2] sm:h-20 sm:w-24">
                            <svg viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg"
                ...
                <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($isPharmacist): ?>
                    <a href="<?php echo e(route('profile.professional-data')); ?>"
                        class="flex h-full items-center gap-4 rounded-3xl bg-white px-4 py-4 shadow-[0_6px_20px_rgba(15,23,42,0.05)] transition-transform hover:scale-[1.01] sm:px-5">
                        <div
                            class="flex h-16 w-20 shrink-0 items-center justify-center rounded-2xl bg-[#e2e5e9] text-[#0b67c2] sm:h-20 sm:w-24">
                    ...
                    <a href="<?php echo e(route('profile.view-pharmacy')); ?>"
                        class="flex h-full items-center gap-4 rounded-3xl bg-white px-4 py-4 shadow-[0_6px_20px_rgba(15,23,42,0.05)] transition-transform hover:scale-[1.01] sm:px-5">
                        <div
                            class="flex h-16 w-20 shrink-0 items-center justify-center rounded-2xl bg-[#e2e5e9] text-[#0b67c2] sm:h-20 sm:w-24">
                            <svg viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg"
                ...
                <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($isPatient): ?>
                    <a href="<?php echo e(route('profile.view-doctors')); ?>"
                        class="flex h-full items-center gap-4 rounded-3xl bg-white px-4 py-4 shadow-[0_6px_20px_rgba(15,23,42,0.05)] transition-transform hover:scale-[1.01] sm:px-5">
                        <div
                            class="flex h-16 w-20 shrink-0 items-center justify-center rounded-2xl bg-[#e2e5e9] text-[#0b67c2] sm:h-20 sm:w-24">
                            <svg viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg"
...
<?php /**PATH C:\Users\pablo\vitalia-api\resources\views/profile/dashboard.blade.php ENDPATH**/ ?>