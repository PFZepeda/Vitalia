<?php $__env->startComponent('layouts.app', ['title' => 'Volverse cuidador']); ?>
...
<?php endif; ?>
				...
				<section class="rounded-3xl bg-white p-6 shadow-[0_6px_20px_rgba(15,23,42,0.05)] sm:p-7">
					...
					<form method="POST" action="<?php echo e(route('profile.be-caregiver.request')); ?>" class="grid grid-cols-1 gap-4">
						<?php echo csrf_field(); ?>
						...
						<div>
							...
							<?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php $__errorArgs = ['patient_email'];
...
unset($__errorArgs, $__bag); ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if ENDBLOCK]><![endif]--><?php endif; ?>
						...
						<button type="submit"
							...
							data-cooldown-until="<?php echo e($cooldownUntil); ?>"
							...
							<?php if($cooldownRemaining > 0): echo 'disabled'; endif; ?>>
							<span data-caregiver-request-button-label>
								<?php echo e($cooldownRemaining > 0 ? "Enviar solicitud ({$cooldownRemaining}s)" : 'Enviar solicitud'); ?>
					...
					<dialog id="caregiver-request-code-modal" class="w-full max-w-lg rounded-3xl border border-slate-200 bg-white shadow-[0_24px_60px_rgba(15,23,42,0.18)]">
						<form method="POST" action="<?php echo e(route('profile.be-caregiver.verify')); ?>" class="flex flex-col p-6 sm:p-8">
							<?php echo csrf_field(); ?>
							...
							<?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($errors->has('code')): ?>
								<p class="text-center text-[13px] text-red-600 font-medium mb-4" id="caregiver-code-error"><?php echo e($errors->first('code')); ?></p>
							<?php else: ?>
					...
					<script>
						document.addEventListener('DOMContentLoaded', () => {
							...
							if (<?php echo e(session('open_caregiver_code_modal') ? 'true' : 'false'); ?>) {
								openModal();
							}
...
<?php echo $__env->renderComponent(); ?>
<?php /**PATH C:\Users\pablo\vitalia-api\resources\views/profile/be-caregiver.blade.php ENDPATH**/ ?>