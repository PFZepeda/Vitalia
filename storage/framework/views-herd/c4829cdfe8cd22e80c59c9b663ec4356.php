...
<?php endif; ?>
        ...
        <div class="flex items-center mb-6">
            <a href="<?php echo e(route('pharmaceutical.dashboard')); ?>" class="text-gray-700 hover:text-gray-900 transition mr-4">
                ...
                <div class="bg-[#f4f4f5] rounded-2xl p-4 sm:p-5 flex items-start relative">
                    ...
                    <div class="flex-shrink-0 mr-4">
                        <div class="h-16 w-16 sm:h-20 sm:w-20 rounded-full bg-[#e3e9ee] flex items-center justify-center text-[#0b67c2] text-2xl sm:text-3xl font-bold">
                            <?php echo e(collect(explode(' ', $patient->name))->map(fn($n) => mb_substr($n, 0, 1))->take(2)->join('')); ?>
                    ...
                    <div class="flex-1 min-w-0">
                        <div class="flex justify-between items-start">
                            <h2 class="text-[15px] sm:text-base font-bold text-black truncate"><?php echo e($patient->name); ?></h2>
                            <a href="<?php echo e(route('pharmaceutical.medications.current', ['patient' => $patient->id])); ?>" class="text-[#0b67c2] hover:text-blue-800 transition ml-2 flex-shrink-0">
                        ...
                        <div class="mt-1 text-sm text-gray-600 space-y-1">
                            <div class="truncate">
                                ...
                                <span class="text-gray-400 underline"><?php echo e($patient->email); ?></span>
                            </div>
                            <div class="flex flex-wrap gap-x-4 gap-y-1">
                                <div><span class="font-bold text-black">Altura:</span> <span class="text-gray-400"><?php echo e($patient->height ?? 'N/A'); ?> m</span></div>
                                <div><span class="font-bold text-black">Peso:</span> <span class="text-gray-400"><?php echo e($patient->weight ?? 'N/A'); ?> kg</span></div>
                                <div><span class="font-bold text-black">Edad:</span> <span class="text-gray-400"><?php echo e($patient->getAge()); ?> años</span></div>
                            </div>
                        </div>
                    </div>
                </div>
...
<?php /**PATH C:\Users\pablo\vitalia-api\resources\views/livewire/pharmaceutical/patient-list.blade.php ENDPATH**/ ?>