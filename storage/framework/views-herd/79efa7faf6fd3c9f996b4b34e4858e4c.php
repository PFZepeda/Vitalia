...
<?php endif; ?>
    ...
    <div class="flex items-center gap-2 px-2" style="min-height: 40px;">
        <a href="<?php echo e(route('admin.dashboard')); ?>" class="text-slate-900 flex-shrink-0">
    ...
    <script>
        (async function() {
            const listUrl = '<?php echo e(route('admin.profile.professional.list')); ?>';
            const viewUrlTemplate = '<?php echo e(route('admin.view-professional-data')); ?>';
...
<?php echo $__env->make('layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\Users\pablo\vitalia-api\resources\views/livewire/admin/validate-professional-data.blade.php ENDPATH**/ ?>