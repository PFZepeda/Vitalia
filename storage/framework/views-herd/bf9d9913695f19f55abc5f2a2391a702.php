...
<?php endif; ?>
    ...
    <div class="flex items-center gap-2 px-2" style="min-height: 40px;">
        <a href="<?php echo e(route('profile.dashboard')); ?>" class="text-slate-900 flex-shrink-0">
...
<div class="prof-container">
  ...
  <form id="professionalForm" action="<?php echo e(route('profile.professional.upload')); ?>" method="POST" enctype="multipart/form-data">
    <?php echo csrf_field(); ?>
...
(() => {
  ...
  const statusUrl = '<?php echo e(route('profile.professional.status')); ?>';
...
<?php echo $__env->make('layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\Users\pablo\vitalia-api\resources\views/profile/professional-data.blade.php ENDPATH**/ ?>