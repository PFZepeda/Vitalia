...
<?php endif; ?>
            ...
            <div class="flex items-center gap-2">
                ...
                <h1 class="text-[22px] font-bold text-slate-900">Mis pacientes</h1>
            </div>
            ...
            <div class="flex items-center gap-3">
                <div class="flex flex-1 items-center rounded-[8px] bg-[#f1f3f5] px-3 py-2.5">
                    ...
                    <input type="text" wire:model.live.debounce.300ms="search" placeholder="Buscar paciente por correo" class="w-full bg-transparent px-2 text-[14px] text-slate-900 focus:outline-none placeholder:text-slate-400">
                </div>
            </div>
            ...
            <div class="flex flex-col gap-4">
                <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::openLoop(); ?><?php endif; ?><?php $__empty_1 = true; $__currentLoopData = $patients; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $patient): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><?php \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::startLoopIteration(); ?><?php endif; ?>
                    ...
                    <div class="relative flex items-center gap-4 rounded-[16px] bg-[#f4f5f7] p-5 shadow-sm">
                        ...
                        <div class="flex-1">
                            ...
                            <p class="text-[13px] text-slate-500 mb-1"><span class="font-bold text-slate-900">Correo:</span> <span class="text-slate-400 font-medium"><?php echo e($patient->email); ?></span></p>
                            <p class="text-[13px] text-slate-500 mb-1"><span class="font-bold text-slate-900">Altura:</span> <span class="text-slate-400 font-medium"><?php echo e($patient->height ?? '1.80'); ?> m</span></p>
                            <p class="text-[13px] text-slate-500"><span class="font-bold text-slate-900">Peso:</span> <span class="text-slate-400 font-medium"><?php echo e($patient->weight ?? '70'); ?> kg</span></p>
                        </div>
                ...
                <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><?php \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::endLoop(); ?><?php endif; ?><?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); if ($__empty_1): ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><?php \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::closeLoop(); ?><?php endif; ?>
                    <p class="text-center text-[14px] text-slate-500 py-6">No se encontraron pacientes asignados a ti.</p>
...
<?php /**PATH C:\Users\pablo\vitalia-api\resources\views/livewire/doctors/my-patients.blade.php ENDPATH**/ ?>