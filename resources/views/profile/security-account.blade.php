    ...
    <div class="relative min-h-screen bg-slate-50">
        ...
        <div id="changePasswordModal" class="fixed inset-0 z-50 hidden items-center justify-center px-4 py-6">
            ...
            <div role="dialog" aria-modal="true" aria-labelledby="changePasswordTitle"
                ...
                <form id="changePasswordForm" method="POST" action="{{ route('profile.security.password') }}"
                    ...
                    <div
                        ...
                        Pregunta asociada: <span
                            class="font-semibold text-slate-900">{{ $securityQuestion ?? 'Sin pregunta de seguridad configurada' }}</span>
                    </div>
                    ...
                    <div>
                        ...
                        @if ($translateValidation('new_password_confirmation'))
                            <p class="mt-2 text-sm text-rose-600">{{ $translateValidation('new_password_confirmation') }}
                            </p>
                        @endif
                    </div>
        ...
        <div id="changeQuestionModal" class="fixed inset-0 z-50 hidden items-center justify-center px-4 py-6">
            ...
            <div role="dialog" aria-modal="true" aria-labelledby="changeQuestionTitle"
                ...
                <form id="changeQuestionForm" method="POST" action="{{ route('profile.security.question') }}"
                    class="mt-6 grid grid-cols-1 gap-4">
                    @csrf
                    ...
                    <div>
                        ...
                        <select id="security_question" name="security_question"
                            ...
                            @foreach ($securityQuestionOptions as $option)
                                <option value="{{ $option }}" @selected(($securityQuestion ?? $securityQuestionOptions[0]) === $option)>{{ $option }}
                                </option>
                            @endforeach
                        </select>
                    </div>
                    ...
                    <div>
                        ...
                        @if ($translateValidation('security_answer_confirmation'))
                            <p class="mt-2 text-sm text-rose-600">
                                {{ $translateValidation('security_answer_confirmation') }}</p>
                        @endif
                    </div>
        ...
        <div id="deleteAccountModal" class="fixed inset-0 z-50 hidden items-center justify-center px-4 py-6">
            ...
            <div role="dialog" aria-modal="true" aria-labelledby="deleteAccountTitle"
                ...
                <form id="deleteAccountForm" method="POST" action="{{ route('profile.security.destroy') }}"
                    class="mt-6 grid grid-cols-1 gap-4">
                    @csrf
                    ...
                    <div>
                        ...
                        @if ($translateValidation('delete_password_confirmation'))
                            <p class="mt-2 text-sm text-rose-600">
                                {{ $translateValidation('delete_password_confirmation') }}</p>
                        @endif
                    </div>
