                ...
                @forelse($patients as $patient)
                    ...
                    <div class="relative flex items-center gap-4 rounded-[16px] bg-[#f4f5f7] p-5 shadow-sm">
                        ...
                        <div class="flex-1">
                            ...
                            <p class="text-[13px] text-slate-500 mb-1"><span class="font-bold text-slate-900">Correo:</span> <span class="text-slate-400 font-medium">{{ $patient->email }}</span></p>
                            <p class="text-[13px] text-slate-500 mb-1"><span class="font-bold text-slate-900">Altura:</span> <span class="text-slate-400 font-medium">{{ $patient->height ?? '1.80' }} m</span></p>
                            <p class="text-[13px] text-slate-500"><span class="font-bold text-slate-900">Peso:</span> <span class="text-slate-400 font-medium">{{ $patient->weight ?? '70' }} kg</span></p>
                        </div>
