...
Route::middleware(['auth:web', 'verified', 'single_session'])->group(function () {
	...
	Route::get('/patient', Dashboard::class)->middleware('role:'.RoleNames::PATIENT.'|'.RoleNames::CAREGIVER.',web')->name('patient.dashboard');
	// Ruta para recetas del paciente
	Route::get('/patient/recetas-paciente', \App\Livewire\Patient\RecetasPaciente::class)->middleware('role:'.RoleNames::PATIENT.'|'.RoleNames::CAREGIVER.',web')->name('patient.recetas');
	// Ruta para medicamentos del paciente
	Route::get('/patient/medicamentos', \App\Livewire\Patient\Medicamentos::class)->middleware('role:'.RoleNames::PATIENT.'|'.RoleNames::CAREGIVER.',web')->name('patient.medicamentos');
